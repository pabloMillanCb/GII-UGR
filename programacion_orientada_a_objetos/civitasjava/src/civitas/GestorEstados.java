...
public class GestorEstados {
  public static EstadosJuego estadoInicial() {
    return (EstadosJuego.INICIO_TURNO);
  }
  
  public static OperacionesJuego operacionesPermitidas(Jugador jugador, EstadosJuego estado) {
  ...
  public static EstadosJuego siguienteEstado (Jugador jugador, EstadosJuego estado, OperacionesJuego operacion) {
